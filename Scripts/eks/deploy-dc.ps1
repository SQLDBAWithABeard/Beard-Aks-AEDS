...
$dataControllerName            = 'ben-eks-cluster-dc' # the name you want for the data controller
$customLocationName            = 'ben-eks-cluster-location' # the name for the custom location that you created in the Create AKS script
...
# it will succeed but it is not ready yet
